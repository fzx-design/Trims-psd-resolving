...
(function() {
  var Descriptor, DropShadow, EffectLayer;

  Descriptor = require('../../descriptor.coffee');

  EffectLayer = require('../effect_layer_info.coffee');

  module.exports = DropShadow = (function() {
    var BLEND_MODES;

    DropShadow.shouldParse = function(key) {
      return key === 'dsdw';
    };
    ...
    DropShadow.prototype.parse = function() {
    ...
    DropShadow.prototype["export"] = function() {
      return {
