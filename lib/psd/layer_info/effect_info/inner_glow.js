...
(function() {
  ...
  module.exports = InnerGlow = (function() {
    var BLEND_MODES;

    InnerGlow.shouldParse = function(key) {
      return key === 'oglw';
    };
    ...
    InnerGlow.prototype.parse = function() {
    ...
    InnerGlow.prototype["export"] = function() {
      return {
